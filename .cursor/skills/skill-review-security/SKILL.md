...
Sources: [rule.security-baseline.mdc](../../rules/rule.security-baseline.mdc), [AGENTS.md](../../../AGENTS.md) (§3, §8), [docs/architecture-and-layers.md](../../../docs/architecture-and-layers.md) (§4, §5, §13). OWASP mapping and grep hints: [reference-owasp.md](reference-owasp.md).
...
- [ ] **No auth logic in Repository or Controller:** the decision belongs to the Service ([rule.business-rules-layers.mdc](../../rules/rule.business-rules-layers.mdc))
...
Agent playbook: [agt-security-review](../../agents/agt-security-review.md).
