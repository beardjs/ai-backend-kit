...
description: >-
  ...
  Does not edit application source or Cursor rules. Coexists with
...
> - [`agt-architecture`](agt-architecture.md) writes Spec-Driven **`design.md`**
...
```text
.cursor/skills/skill-architecture-discovery/templates/profile.md
```
...
- Before proposing Cursor rules from real structure on a **diverged** repo
...
4. Never edit application source or `.cursor/rules/`.
