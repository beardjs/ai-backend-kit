...
- [.claude/rules/semantic-quality.md](../../rules/semantic-quality.md)
- [.claude/rules/naming-patterns.md](../../rules/naming-patterns.md)
- [.claude/rules/business-rules-layers.md](../../rules/business-rules-layers.md)

Playbooks when HTTP or naming is in scope:

- [.claude/skills/review-naming/SKILL.md](../../skills/review-naming/SKILL.md)
- [.claude/skills/review-rest-endpoints/SKILL.md](../../skills/review-rest-endpoints/SKILL.md)
...
- Interfaces: `I*` domain, `IM*` Mongo — see the `naming-patterns` rule.
...
2. Apply naming checklist from the `review-naming` skill.
3. If HTTP files involved, apply the `review-rest-endpoints` skill.
