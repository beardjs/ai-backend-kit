...
layer and naming rules in [agt-dev-backend](../../agents/sdd/agt-dev-backend.md).
...
Necessary change outside approved scope → orchestrator (main thread) + agt-product-owner
External dependency unavailable         → orchestrator (main thread)
```
...
- [agt-dev-backend](../../agents/sdd/agt-dev-backend.md)
