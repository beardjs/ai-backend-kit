...
- [release.md](../../rules/release.md) — Conventional Commits for semantic-release
- [reference.md](reference.md) — org defaults (base branch, attribution policy)
- [agt-github-workflow](../../agents/ops/agt-github-workflow.md) — orchestrator agent
...
- **scope** — optional; domain context (`user`) or layer (`domain`, `contracts`, `claude`)
...
chore(claude): add github workflow agent
...
Full mock/layout policy: [tests.md](../../rules/tests.md), [tests-layered skill](../tests-layered/SKILL.md) — do not restate mock rules here.
...
- AI/IDE attribution in commits or PRs: `Made with Cursor`, `Generated with Claude Code`, `Co-authored-by: Claude`, “Generated with …” emoji trailers, or any similar footer — strip before commit/PR create ([git-no-ai-attribution.md](../../rules/git-no-ai-attribution.md))
