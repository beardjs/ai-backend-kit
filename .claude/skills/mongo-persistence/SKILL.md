...
**Do not use** for a brand-new context from scratch — see [new-context](../new-context/SKILL.md).
...
5. **DB errors** — see [domain-errors](../domain-errors/SKILL.md) (`DATABASE_ERROR`, `serviceLogErrorHandler`).
