...
Sources: [docs/architecture-and-layers.md](../../../docs/architecture-and-layers.md) (§3–5), [semantic-quality.md](../../rules/semantic-quality.md), [naming-patterns.md](../../rules/naming-patterns.md).
...
3. Check class/interface prefixes (`I`, `IM`, `E`) per [naming-patterns.md](../../rules/naming-patterns.md).
...
Agent playbook: [agt-naming-refactor](../../agents/review/agt-naming-refactor.md).
