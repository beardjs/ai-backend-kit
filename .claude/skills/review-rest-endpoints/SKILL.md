...
context: fork
agent: agt-rest-endpoint-design
argument-hint: "[controller paths or context]"
---

# Skill: review REST endpoints

Review scope: $ARGUMENTS (when empty, review every controller in `src/application/controllers/`).
...
Sources: [docs/architecture-and-layers.md](../../../docs/architecture-and-layers.md) (§4 Application, §7), [semantic-quality.md](../../rules/semantic-quality.md), [contracts-openapi.md](../../rules/contracts-openapi.md).
...
Related: [add-http-endpoint](../add-http-endpoint/SKILL.md) (implement), [openapi-contract](../openapi-contract/SKILL.md) (sync YAML).
